...
import com.itmy.picture.service.IQiniuService;
import com.itmy.picture.utils.QiniuUtil;
...
public class QiniuServiceImpl implements IQiniuService {
    ...
    public String uploadPictureByUrl(String itemUrl) {
        ...
        try {
            ...
            out.flush();
            out.close();
            return qn.uploadQiniu(dest);
        } catch (Exception e) {
            log.error(e.getMessage());
            throw new ParamException("系统配置有误");
        } finally {
    ...
    private String uploadSingleFile(MultipartFile multipartFile) {
        ...
        try {
            ...
            out.flush();
            out.close();
            url = qiniuUtil.uploadQiniu(dest);
        } catch (Exception e) {
            e.getStackTrace();
